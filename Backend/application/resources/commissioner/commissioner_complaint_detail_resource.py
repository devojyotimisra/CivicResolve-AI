...
from application.helpers.models import Complaint, ComplaintUpdate, Department, User
from application.helpers.schemas import (
    CommissionerComplaintDetailResponse,
    ComplaintSchema,
...
@router.get(
    "/commissioner/complaint/{complaint_id}", response_model=CommissionerComplaintDetailResponse
)
