...
from application.resources.officer.officer_dashboard_resource import router as officer_dash_router
from application.resources.officer.officer_ticket_detail_resource import router as officer_ticket_detail_router
from application.resources.officer.officer_ticket_update_status_resource import router as officer_status_router
from application.resources.officer.officer_ticket_resolve_resource import router as officer_resolve_router
from application.resources.officer.officer_history_resource import router as officer_history_router
from application.resources.officer.officer_search_resource import router as officer_search_router
from application.resources.officer.officer_profile_fetch_resource import router as officer_profile_fetch_router
from application.resources.officer.officer_profile_update_resource import router as officer_profile_update_router

from application.resources.commissioner.commissioner_dashboard_resource import router as comm_dash_router
from application.resources.commissioner.commissioner_complaints_list_resource import router as comm_complaints_router
from application.resources.commissioner.commissioner_complaint_detail_resource import router as comm_complaint_detail_router
from application.resources.commissioner.commissioner_assign_officer_resource import router as comm_assign_router
from application.resources.commissioner.commissioner_officers_list_resource import router as comm_officers_list_router
from application.resources.commissioner.commissioner_officer_add_resource import router as comm_officer_add_router
from application.resources.commissioner.commissioner_officer_update_resource import router as comm_officer_update_router
from application.resources.commissioner.commissioner_officer_delete_resource import router as comm_officer_delete_router
from application.resources.commissioner.commissioner_facilities_list_resource import router as comm_facilities_list_router
...
from application.resources.commissioner.commissioner_bills_list_resource import router as comm_bills_list_router
