...
export const AnonymousComplaint = () => {
    ...
    const submitForm = (e) => {
        ...
        if (!description.trim() && !photoFile) {
            toast.error("Please provide either a detailed description or media evidence.");
            return;
        }
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const result = await complaintService.fileAnonymousComplaint(complaintData);

            const token = result.trackingToken;
            setSubmittedToken(token);
            setIsFormModalOpen(false);
            setConfirmSubmit(false);
            toast.success("Civic report submitted successfully! AI is processing your report.");
        } catch (err) {
        ...
        <div className="flex-1 flex flex-col justify-center p-4 sm:p-6 lg:p-8 bg-gradient-to-b from-background via-background/90 to-muted/30 relative overflow-hidden">
            ...
            <div className="max-w-3xl mx-auto w-full space-y-8 my-auto">
                <div className="text-center space-y-3">
                    ...
                    <p className="text-base sm:text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
                        Submit road hazards, overflowing waste, or broken street lights directly to
                        municipal crews without revealing your identity.
                    </p>
                </div>
            ...
            <Dialog open={isFormModalOpen} onOpenChange={setIsFormModalOpen}>
                <DialogContent
                    ...
                    className="max-w-3xl border-2 border-primary/20 shadow-2xl bg-card/95 backdrop-blur-xl p-0 overflow-hidden"
                >
            ...
            >
                <DialogContent
                    onOpenAutoFocus={(e) => e.preventDefault()}
                    className="sm:max-w-md border-2 border-primary/30 shadow-2xl bg-card/95 backdrop-blur-xl p-6 overflow-hidden"
                >
                    <DialogHeader className="text-center space-y-3 pt-2">
                        ...
                        <DialogDescription className="text-xs text-muted-foreground leading-relaxed max-w-sm mx-auto text-center">
                            Save this code immediately. It is your ONLY key to track resolution
                            progress and verify resolution photo proof. AI is analyzing your report
                            in the background.
                        </DialogDescription>
                    </DialogHeader>
