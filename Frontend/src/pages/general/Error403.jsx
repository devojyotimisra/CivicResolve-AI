            ...
            <Card className="w-full max-w-md border shadow-2xl bg-card text-center p-6 space-y-6">
                ...
                <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                        You do not have the required municipal clearance or role privileges to view
                        this administrative portal.
                    </p>
                </div>

                <div className="p-3 rounded-lg bg-muted/60 border text-xs text-muted-foreground">
                    If you are a City Commissioner or Field Officer, please verify that you are
                    signed in with your official municipal credentials.
                </div>
            </Card>
        </div>
    );
