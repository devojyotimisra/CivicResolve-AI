...
export const CitizenFacilities = () => {
    ...
    const handleBookSubmit = async () => {
        ...
        const isBooked = allBookings.some(
            (b) => b.facilityId === selectedFacility.id && b.bookedDate === selectedDateStr
        );
        if (isBooked) {
            toast.error("This date is already booked. Please choose another date.");
            return;
    ...
    return (
        <div className="space-y-6 pb-10">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b pb-4">
                <div>
                    ...
                    <p className="text-xs sm:text-sm text-muted-foreground">
                        Explore municipal community halls and parks, reserve venues online, and view
                        your confirmed booking permits.
                    </p>
                </div>
                ...
                <>
                    <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center justify-between">
                        ...
                        <div className="flex gap-2 shrink-0 overflow-x-auto pb-1 sm:pb-0">
                            ...
                            <Button
                                variant={typeFilter === "Community Hall" ? "default" : "outline"}
                                size="sm"
                                ...
                                <div className="flex flex-col items-center">
                                    ...
                                    <div className="bg-background rounded-xl border p-2 shadow-sm">
                                        <Calendar
                                            ...
                                            modifiersClassNames={{
                                                booked: "bg-destructive/20 !text-destructive font-bold line-through border border-destructive/40 !opacity-100",
                                            }}
                                            className="p-3"
                                        />
                                    </div>
                                ...
                                <div className="flex-1 space-y-4 w-full">
                                    <div className="p-3 rounded-xl bg-card border space-y-2">
                                        ...
                                        <div className="flex justify-between items-center text-sm font-bold">
                                            ...
                                            <span>
                                                ₹
                                                {selectedFacility.pricePerDay.toLocaleString(
                                                    "en-IN"
                                                )}{" "}
                                                / day
                                            </span>
            ...
            <Dialog
                open={confirmBooking}
                onOpenChange={(open) => !open && !bookingLoading && setConfirmBooking(false)}
            >
                <DialogContent
                ...
                >
                    <DialogHeader>
                        ...
                        <DialogDescription className="text-xs">
                            Complete your payment for booking {selectedFacility?.name} on{" "}
                            {selectedDateStr}.
                        </DialogDescription>
                    </DialogHeader>
