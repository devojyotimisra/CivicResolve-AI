...
const COLORS = ["#0088FE", "#00C49F", "#FFBB28", "#FF8042", "#8884d8", "#8dd1e1", "#f472b6"];
    ...
    return (
        <div className="space-y-6 pb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="border shadow-md">
                    <CardHeader className="pb-2 border-b">
                        <CardTitle className="text-base font-bold">Tickets by Department</CardTitle>
            ...
            <Card className="border shadow-md mt-6">
                <CardHeader className="pb-2 border-b">
                    <CardTitle className="text-base font-bold">7-Day Operational Trend</CardTitle>
                    <CardDescription className="text-xs">
