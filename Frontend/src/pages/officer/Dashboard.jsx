          ...
          <Card className="border shadow-md">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-xs">
                Active maintenance tickets requiring field inspection. Click the
        ...
        <TabsContent value="resolved" className="space-y-4">
          <Card className="border shadow-md">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-xs">
                History of tickets completed by field crews with photographic
                proof. Click the eye icon to view timeline.
              </CardDescription>
            </CardHeader>
                        ...
                        <Card className="border-2 border-primary/30 shadow-lg bg-card mt-4 w-full">
                          <CardHeader className="pb-3 border-b bg-muted/30">
                            <CardTitle className="text-base flex items-center gap-2 text-foreground">
                              <FileCheck className="w-4 h-4 text-primary" />
                              <span>Submit Resolution Proof & Note</span>
                            </CardTitle>
                            <CardDescription className="text-xs">
                              Required to verify fulfillment and notify citizen.
                            </CardDescription>
                          </CardHeader>
                          <CardContent className="pt-4">
                            ...
                            >
                              ...
                              <div className="space-y-2">
                                ...
                                >
                                  Engineering Resolution Summary Note
                                </Label>
                                <Textarea
                                  id="modal-res-note"
                                  rows={3}
