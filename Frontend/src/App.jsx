...
import { CommissionerFacilityTypes } from "@/pages/commissioner/FacilityTypes";
...
const DashboardRedirect = () => {
    ...
    if (user?.role === "commissioner") return <Navigate to="/dash/commissioner" replace />;
                            ...
                            <ProtectedRoute allowedRoles={["commissioner"]}>
                                <DashboardLayout>
                                    <Routes>
                                        ...
                                        <Route
                                            path="/facility-types"
                                            element={<CommissionerFacilityTypes />}
                                        />
                                        <Route
                                            path="/departments"
