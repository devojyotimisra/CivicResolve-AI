            ...
            return (
                <div className="flex flex-col items-center justify-center h-52 text-center p-6 border border-dashed rounded-2xl bg-muted/20 my-3 animate-in fade-in-50 duration-300">
                    ...
                    <p className="text-xs text-muted-foreground mt-1 max-w-[200px]">
                        You're all caught up! When civic alerts occur, they will appear right here.
                    </p>
                </div>
            );
        }
        ...
        <>
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                >
                    ...
                    <Tabs defaultValue="all" className="flex-1 flex flex-col min-h-0 mt-3">
            ...
            <Dialog open={!!confirmDelete} onOpenChange={(val) => !val && closeConfirm()}>
                <DialogContent
                    onOpenAutoFocus={(e) => e.preventDefault()}
                    className="w-[90vw] sm:w-full max-w-md bg-card/95 border shadow-2xl rounded-2xl p-6 z-[60] text-foreground"
                >
                    <DialogHeader className="text-left">
                        ...
                        <DialogDescription className="text-sm text-muted-foreground mt-2">
                            ...
                            {confirmDelete?.title || "this notification"}"? This action cannot be
                            undone.
                        </DialogDescription>
                    </DialogHeader>
            ...
            >
                ...
                >
                    <DialogHeader className="text-left">
                        ...
                        <DialogDescription className="text-sm text-muted-foreground mt-2">
                            Are you sure you want to permanently delete all your notifications? This
