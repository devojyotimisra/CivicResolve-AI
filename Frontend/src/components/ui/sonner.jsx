  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-card group-[.toaster]:text-card-foreground group-[.toaster]:border-2 group-[.toaster]:border-border/80 group-[.toaster]:shadow-[0_12px_30px_rgba(0,0,0,0.35)] group-[.toaster]:rounded-xl font-sans antialiased",
          description:
            "group-[.toast]:text-muted-foreground font-normal text-xs mt-0.5",
          actionButton:
